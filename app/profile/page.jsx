...
import getFirstCharacters from "@/src/util/common";
  ...
  const profileContent = (
    <Card>
      ...
      <div className="profile-form">
        ...
        <Input label="New Password:" type="password" placeholder="Enter new password" onChange={(e) => setNewPassword(e.target.value)} />
      </div>
      <div className="address-section">
        <Addresses addresses={addresses} setAddresses={setAddresses} editable="true" />
